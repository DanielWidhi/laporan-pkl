        ...
        <aside className="hidden w-64 flex-col border-r bg-slate-50 md:flex h-screen sticky top-0">
            <div className="flex h-14 items-center border-b px-4 lg:h-[60px] lg:px-6">
                <Link href="/dashboard" className="flex items-center gap-2 font-semibold">
                    ...
                    <span className="">SiPekal (PKL)</span>
                </Link>
            </div>
            <div className="flex-1 overflow-auto py-2">
                <nav className="grid items-start px-2 text-sm font-medium lg:px-4 gap-2">
                    ...
                    {/* Menu Admin (Nanti kita sembunyikan pakai logika jika bukan admin) */}
                    <div className="mt-4 mb-2 px-3 text-xs font-semibold uppercase text-slate-500">
                        Area Admin
                    </div>
                    <Link
